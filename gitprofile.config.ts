...
const CONFIG = {
  ...
  social: {
    ...
    behance: '',
    medium: '',
    dev: 'https://leetcode.com/u/out-of-context/',
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1iCU1YTvDVilKRoTtcxDBQ9BpruCkva6C/view?usp=drive_link', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Angular',
    'TypeScript',
